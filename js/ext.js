!function (e, n, m, p) {
  XF.DBTechUserTaggingEditorHashTagger = XF.create({
    ...
    getCurrentHashTagInfo: function () {
      ...
      d = c.lastIndexOf('#');
      if ( - 1 == d) return null;
      if (0 == d || c.substr(d - 1, 1).match(/(\s|[\](,]|--)/)) if (c = c.substr(d + 1), !c.match(/\s/) || 10 >= c.length) return {
        textNode: a,
        start: d,
        name: c.replace(new RegExp(String.fromCharCode(160), 'g'), ' '),
        range: b
      };
      return null
    },
  ...
  XF.DBTechUserTagging = {
    init: function (b, a, c) {
      ...
      console.log(a);
      edx = e("textarea");
      edx.froalaEditor = exd[0]["data-froala.editor"];
    },
      ...
      e.FE.PLUGINS.bbCode = function (a) {
        ...
        function g(c, e) {
          ...
          l = function (c, d) {
            k = !0;
            var e;
            (e = a.$oel.data('xfSmilieBox')) && e.hasClass('is-active') && XF.EditorHelpers.toggleSmilieBox(a, !1);
            a.undo.saveStep();
            a.$el.blur();
            e = b();
